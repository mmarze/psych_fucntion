...
vis_beta_P1 <- c(16.9317, 12.0115, 13.6162, 18.4521, 16.3095, 21.7170, 
                 18.8365, 30.5492, 17.0039, 18.7317, 16.0615)
ir_beta_P1 <- c(36.4178, 37.1673, 25.6775, 34.0700, 31.6388, 36.9355, 
               38.7069, 31.6107, 23.9046, 43.5405)
vis_beta_P26 <- c(29.9098, 20.3406, 25.9845, 16.7547)
ir_beta_P26 <- c(15.2449, 24.3758, 33.9389, 32.3291)
vis_beta_P36 <- c(17.2640, 19.0161, 21.2769, 25.4831, 18.6112, 18.6153)
...
var_test <- bartlett.test(c(vis_beta, ir_beta), c(rep(1, length(vis_beta)), rep(2, length(ir_beta))))
print(var_test)

# test for equal median values
median_test <- wilcox.test(vis_beta, ir_beta, alternative = "two.sided", var.equal = F)
print(median_test)
